...
class Gui_Mirror():
    ...
    def popwind_device(self):
        ...
        tkinter.Button(self.popwind1, text='连接', width=10, command=connect).place(x=300, y=550, anchor='nw')
        tkinter.Button(self.popwind1, text='保存', width=10, command=onSumbitClick).place(x=400, y=550, anchor='nw')
        tkinter.Button(self.popwind1, text='删除', width=10, command=deletedata).place(x=500, y=550, anchor='nw')
